...
Tags: video, video player, player, youtube videos, playlists,
...
* [Demo](https://huge-it.com/wordpress-plugins-video-player-demo/)
* [FAQ Video Player](https://huge-it.com/wordpress-video-player-faq/)
* [User Manual](https://huge-it.com/wordpress-video-player-user-manual/)
* [Support](https://huge-it.com/contact-us/)
* [Forum](https://huge-it.com/forums/forum/wordpress/wordpress-video-player/)
* [Github Project](https://github.com/Huge-IT/video-player)
...
The most outstanding feature is that our Vplugin gives you two ways to display videos: 
First way is Single, here you can see your videos next to each other or under each other in a line with several players 
The second way is Album, here you can watch your videos in one with the list of the rest your videos 
Our video player allows to write a title of your video file. Also with player you can make changes on size, playlist layout and set autoplay mode. 
...
Those people, who prefer a more fine-tuning, please take a glance on General Options provided in pro version of the Huge-IT video Player, where you can adjust the appearance of your player the best for you. Configuration of many options will make your video player look special and act as you need. 
...
Now you can set your options, images and use.

== Screenshots ==

1.  [Demo 1 Playlist View](https://huge-it.com/wordpress-plugins-video-player-demo/)
2.  [Demo 2 Single View](https://huge-it.com/wordpress-video-player-demo-2-single-view/)
3.  [Demo 3 Full width Album](https://huge-it.com/wordpress-video-player-demo-3-full-width-album/)
...
* 2) Important! Add roles for Editors, now editors can see plugin if they want to share it with editors in the back-end
...
* 2) We have also used this bug fix opportunity to update the main banner of the plugin page in order to mention all the features, so that users will get the full plugin information vividly.
...
*  Name. Here you can make changes on title
*  Type. Choose to display as single videos or in album
*  Playlist Layout. Choose where to place
*  Autoplay. On will automatically play the video
*  Video With (px).  Set width size

### Step 3. Inserting Plugin
...
From this section you can make all kind of design customization. General Options are available for users with premium license 

**Options**

Background Color. Choose some color for your background area

Border Size. Select a number, and you will have border, bigger number - thicker border

Border Color.Choose color for border line

Positioning. You can place the on the center/right/left within theme container	

Margin Top. Give margin on top

Margin Bottom. Give marin to the bottom

Margin Right. Give margin on the right side

Margin Left. Give margin on the left side
...
Controls Panel Color. Set color on control panel
...
Theme. Decide a theme for youtube, dark or light
